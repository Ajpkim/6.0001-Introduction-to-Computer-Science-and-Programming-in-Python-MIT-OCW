...
##  my mistaken attempt.. overcomplicating and screwing up the formal parameters...
...
#    
#    for i in range(len(my_word)):
#        if my_word[i] != '_' and my_word[i] != get_guessed_word[i]:
#            return False
#    
#    return True 
...
def show_possible_matches(my_word):
    ...
    '''
    #so need to use apply above function to every single word in wordlist to accumulate the possible matches
    # need to look inside wordlist and apply match_with_gaps to every word
    # going to create list of all the words and then print that list
