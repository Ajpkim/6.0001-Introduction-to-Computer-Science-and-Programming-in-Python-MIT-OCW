...
#    Initialize hand counter, total score, substition & replay trackers
    ...
    while rounds_played != rounds_to_play:
        ...
        print ('-------------------------------------------\nYour total score is now', total_score, 'points.')
...
#    the really smooth cases
    ...
    # Need to understand how to handle bad user inputs better... raising exceptions and forcing user to give good input before moving on.
